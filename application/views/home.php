<div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom shadow-sm">
  <h5 class="my-0 mr-md-auto font-weight-normal">Pemrograman Web Lanjut</h5>
...
<div class="pricing-header px-3 py-1 pt-md-3 pb-md-4 mx-auto text-center">
  <h1 class="display-4 pt-0">Tabel Nilai Kelas RS</h1>
    ...
    foreach ($nilai as $data): ?>
      <tr <?php if ($data['keterangan']=="Tidak Lulus"){echo "class='bg-warning'";} ?>>
        ...
        <td class="align-middle text-center">
          ...
          <a href="<?=base_url('pweb/delete/' .$data['id_nilai'])?>" onclick="return confirm('Anda yakin ingin menghapus data ini?')" class="align-middle btn btn-danger">Hapus</a>
        </td>
      </tr>
      <?php endforeach  ?>
    </tbody>
